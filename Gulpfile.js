...
settings.currentDir = currentDir();
settings.relativePath = __dirname;
...
settings.tdd = (getArgs.tdd === undefined) ? false : true;
...
gulp.task('help', function() {
    ...
    helpMsg += '\n    gulp test  [--tdd]     > Runs unit tests in Karma, enable flag --tdd to continuous mode.';
...
gulp.task('test', require('./gulp/tasks/karma.js')(gulp, settings, plugins, confGlobal, confFileMap, karmaServer, pathFiles, notify));
